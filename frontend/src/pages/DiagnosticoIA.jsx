...
export default function DiagnosticoIA() {
  ...
  const tienePlan = user?.plan === 'pro' || user?.plan === 'premium';
  ...
  return (
    <div>
      ...
      <div className="max-w-[720px] p-8">
        {!tienePlan ? (
          <div className="rounded-card border border-resin/30 bg-resin/10 p-5 text-[13.5px] text-resin">
            El diagnóstico por IA está disponible en los planes Pro y Premium.{' '}
            <a href="/planes" className="underline">Ver planes →</a>
          </div>
        ) : (
          <>
